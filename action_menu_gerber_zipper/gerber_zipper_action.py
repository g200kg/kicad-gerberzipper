...
#        status=wx.StaticBox(self.panel, wx.ID_ANY, 'Ready', pos=(0,190), size=(300,20))
        ...
        self.opt_DrillUnit = wx.ComboBox(self.panel, wx.ID_ANY, '', choices=('inch','mm'), style=wx.CB_READONLY, pos=(510,410), size=(60,25))
        ...
        self.opt_InstructionFile = wx.TextCtrl(self.panel, wx.ID_ANY, '', size=(120,18), pos=(40 + 5 + self.opt_InstructionLabel.GetSize().GetWidth(),620))
    ...
    def Run(self):
        class Dialog(wx.Dialog):
            def __init__(self, parent):
                ...
                vbox.Add(wx.StaticText(self.panel, wx.ID_ANY, getstr('LABEL')),flag=wx.ALL, border=20)
                row1 = wx.BoxSizer(wx.HORIZONTAL)
                row1.Add(wx.StaticText(self.panel, wx.ID_ANY, 'Manufacturers :',size=(120,30)))
                self.manufacturers = wx.ComboBox(self.panel, wx.ID_ANY, 'Select Manufacturers', choices=manufacturers_arr, style=wx.CB_READONLY)
                row1.Add(self.manufacturers)
                vbox.Add(row1, flag=wx.LEFT, border=20)
                row2 = wx.BoxSizer(wx.HORIZONTAL)
                row2.Add(wx.StaticText(self.panel, wx.ID_ANY, 'URL :',size=(120,30)))
                self.url = wx.TextCtrl(self.panel, wx.ID_ANY, '', size=(270,20), pos=(120,70), style=wx.TE_READONLY)
                row2.Add(self.url)
                vbox.Add(row2, flag=wx.LEFT, border=20)
                row3 = wx.BoxSizer(wx.HORIZONTAL)
                row3.Add(wx.StaticText(self.panel, wx.ID_ANY, 'Gerber Dir :',size=(120,30)))
                self.gerberdir = wx.TextCtrl(self.panel, wx.ID_ANY, '')
                row3.Add(self.gerberdir)
                vbox.Add(row3, flag=wx.LEFT, border=20)
                row4 = wx.BoxSizer(wx.HORIZONTAL)
                row4.Add(wx.StaticText(self.panel, wx.ID_ANY, 'Zip Filename :',size=(120,30)))
                self.zipfilename = wx.TextCtrl(self.panel, wx.ID_ANY, '')
                row4.Add(self.zipfilename)
                vbox.Add(row4, flag=wx.LEFT, border=20)
                row5 = wx.BoxSizer(wx.HORIZONTAL)
                row5.Add(wx.StaticText(self.panel, wx.ID_ANY, 'Description :',size=(120,30)))
                self.label = wx.StaticText(self.panel, wx.ID_ANY, '')
                row5.Add(self.label)
                vbox.Add(row5, flag=wx.LEFT, border=20)
                vbox.Add(wx.StaticLine(self.panel, wx.ID_ANY))

                self.manufacturers.SetSelection(0)
                self.execbtn = wx.Button(self.panel, wx.ID_ANY, getstr('EXEC'))
                self.clsbtn = wx.Button(self.panel, wx.ID_ANY, getstr('CLOSE'))
                self.detailbtn = wx.ToggleButton(self.panel, wx.ID_ANY, getstr('DETAIL'))
                ...
                row6.Add(self.detailbtn)
                row6.Add((50,0))
                row6.Add(self.execbtn)
                row6.Add(self.clsbtn)
                vbox.Add(row6, flag=wx.LEFT, border=20)
